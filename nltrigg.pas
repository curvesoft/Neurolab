...
const triggermax=65520 div sizeof(messwert) -12;
      listmax='H';
...
{         procedure triggern (dabei:filemenge); virtual;}
      ...
      diffilter=object (doppeltriggerfilter)
         ...
         constructor neu(retrigliste,ertrigliste:char; msmax:longint; typchar:char);
         procedure einheitgenerieren(var beleg:belegung); virtual;
         function gefiltert (posi:longint):sample; virtual;
         constructor load (var s:tbufstream);
         procedure store (var s:tbufstream);
...
function asciifilter.gefiltert (posi:longint):sample;
var   li,re:word;
      liposi,reposi:longint;
      liwert,rewert:comp;
begin
...
constructor diffilteralt.neu(retrigliste,ertrigliste:char; msmax:longint);
begin
...
function diffilteralt.gefiltert (posi:longint):sample;
var   stelle:messwert;
      li,re:word;
...
constructor diffilter.neu(retrigliste,ertrigliste:char; msmax:longint; typchar:char);
begin
retrliste:=retrigliste; ertrliste:=ertrigliste;
...
function tlintfilter.gefiltert (posi:longint):sample;
var  i:longint;
     li,re:word;
begin
with trdaten do begin
