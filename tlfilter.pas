...
type  { Einheiten der Y-Achsen }
     ...
     { X-Achsen-Verschiebungs - Filter }
      ...
      digital=object (filter)
       public
         constructor neu (k:byte; schwelle:sample);
       private
         schw:sample;
         gefiltertwert:sample;
         posilinkswert,posirechtswert:longint;
         procedure einheitgenerieren (var beleg:belegung); virtual;
         procedure vorbereitung (frequenz:extended); virtual;
         function gefiltert (posi:longint):sample; virtual;
         constructor load (var s:tbufstream);
...
function betrag.gefiltert (posi:longint):sample;
var ys,zs:extended;
begin
...
function winkel.gefiltert (posi:longint):sample;
const fak=maxsample/pi;
      halb=round(fak*pi);
var x,y:sample;
    winkel:sample;
...
constructor digital.neu (k:byte; schwelle:sample);
begin
schw:=schwelle;
...
function digital.gefiltert (posi:longint):sample;
var li,re,minli,maxre:longint;
begin
